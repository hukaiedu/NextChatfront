...
const cn = {
  ...
  Account: {
    ...
    LoginTitle: "欢迎回来",
    LoginSubtitle: "继续你的对话",
    RegisterTitle: "创建你的 personChat 账号",
    RegisterSubtitle: "创建账号，保留你的对话",
    Username: "用户名",
  ...
  Browser: {
    ...
    Hint: {
      ...
      RESTARTING: "正在重启浏览器，请稍候",
      STOPPED: "浏览器已关闭，重启或发送新消息时会重新拉起",
      FAILED: "浏览器异常，可尝试重启或查看后端日志",
      UNKNOWN: "尚未获取到浏览器状态",
    },
    Fields: {
      StartedAt: "启动时间",
    ...
    RestartTip: "重启会中断正在进行的回答",
    RestartConfirm: "重启会中断正在进行的回答，确认重启服务端浏览器？",
    RestartSuccess: "服务端浏览器已重启",
